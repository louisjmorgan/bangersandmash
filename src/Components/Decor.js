  ...
  return (
    <StyledDecorText>
      <p>
        ...
        installation art, and are proud of our already vast and
        eclectic supply of decoration. Alongside dance floor decor, a
        selection of lights, smoke machines, bubble machines and
        lasers will be on hand for impromptu multi-sensory fun,
        wherever the party takes us! If you’ve got some cool stuff or
        would like to make something new, bring it down! We can help
        if you’d like some funding or support to make your dream a
        reality.
      </p>
    </StyledDecorText>
  );
